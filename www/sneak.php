...
var sneak_base_url = 'https://'+'<? echo get_server_name().$globals['base_url'];?>'+'backend/sneaker2.php';
...
<script type="text/javascript" src="https://<? echo get_server_name().$globals['base_url']; ?>js/sneak14.js.php" charset="utf-8"></script>
<?
